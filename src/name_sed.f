...
c	Array declaration
	...
	character atlas,evofile*(*),phase(16)*7,fract(nb)*4,stage(nb)*5,savefile*512,imf(-1:20)*7,tempfile*512,subdir*512,auxname*16
...
!	Modified to include WR stars (Dec 2013)
	data phase/'ms','sgb','rgb','hb','agb','Orich','Crich','SWphase','cspn','wd',   'ccb',  'other','WNL','WNE','WC','WO'/
...
!	Various IMF's options
	data imf /'chab','chab','kroup','KROUP','salp','scalo','SCALO','mi_sc','ktg93','kenn', 'leque','ferra','piott','carig','thIMF','myIMF','vxpxx','Schab','Skroup','Ssalp','S2plIMF','NumIMF'/

!       Use to handle IMF populated stochastically
        character*128 popprm
        common /stochnamef/ popprm
...
!	Open files to write sed''s of each stellar group (16 files: lun+15 - lun+30)
...
!		write (6,*) 'lun+17 =',lun+17,' ',evofile(1:largo(evofile))
		...
		write (lun+17,'(a)') '#    (1)       (2)         (3)         (4)         (5)'
		write (lun+17,'(a)') '#'
		write (lun+17,'(a)') '#log-age-yr  Mass_high   Mass_low    Mass_tot      Mcut'
...
c	Returns the value of jdef corresponding to the IMF selected in name
...
c	Check if Padova tracks are selected ( = Padova 1994/2000/2007/2008)
c	Check if Weiss 2008 tracks are selected
c	Modifies file name accordingly

	logical cb07
	character*(*) name
        character  a94(7)*3,b94(7)*3
c       character  a00(6)*4,b00(6)*4
c       character  a20(6)*3,b20(6)*4
c       character  a07(8)*4,b07(8)*3
        character  a08(10)*4,b08(10)*3
        character  a08b(10)*4,b08b(10)*3
        character  a10(10)*4,b10(10)*3
        character  a13(15)*4,a14(15)*4,b13(15)*9
...
c	CB2013 models
	data a13 /     'm300',     'm301',     'm302',     'm303',    'm304',    'm305',    'm306',    'm307',    'm308',    'm309',    'm310',    'm311',    'm312',    'm313',    'm314'/  ! SET 1
	data a14 /     'm400',     'm401',     'm402',     'm403',    'm404',    'm405',    'm406',    'm407',    'm408',    'm409',    'm410',    'm411',    'm412',    'm413',    'm414'/  ! SET 2
	data b13 /'z0000y230','z0001y249','z0002y249','z0005y249','z001y250','z002y252','z004y256','z006y259','z008y263','z010y267','z014y273','z017y279','z020y284','z030y302','z040y321'/

c	Coelho et al models
...
c	Store in common model option
	common /model/ kopt

c	Look for different option numbers to correct file name
	kopt=3
	cb07=.false.
	do i=1,7
	j=index(name,a94(i))
