...
c	Builds script to perform correct file assignments for program mix_stelib

c	Variables
	character*(*) a,b

c	Find first and third occurrence of character '_'
...
c		Write script to use program mix_stelib
